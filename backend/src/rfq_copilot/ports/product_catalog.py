...
class ProductCatalogPort(Protocol):
    async def search(self, query: ProductSearchQuery) -> Awaitable[ProductSearchResult] | ProductSearchResult: ...

    async def get_detail(self, product_id: str) -> Awaitable[ProductDetail | None] | ProductDetail | None: ...
